...
#include <SoakDeployment/Top/SoakDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SoakDeployment::setupTopology(inputs);
    SoakDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SoakDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
