// ======================================================================
// \title  SoakDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SOAKDEPLOYMENT_SOAKDEPLOYMENTTOPOLOGY_HPP
#define SOAKDEPLOYMENT_SOAKDEPLOYMENTTOPOLOGY_HPP
// Included for access to SoakDeployment::TopologyState and SoakDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SoakDeployment/Top/SoakDeploymentTopologyDefs.hpp>

// Remove unnecessary SoakDeployment:: qualifications
 ...
 * SoakDeployment::TopologyState see: SoakDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SoakDeployment::TopologyState see: SoakDeploymentTopologyDefs.hpp.
 *
